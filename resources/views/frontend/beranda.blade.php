...
<body>
    <div class="boxed_wrapper">
                            ...
                            <nav class="main-menu">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        <li class="home current"><a href="index.html"><span
            ...
            <div id="slider1" class="rev_slider" data-version="5.0">
                <ul>
                    ...
                    <li data-transition="slidingoverlayleft">
                        <img src="images/slides/1.jpg" alt="" width="1920" height="550"
                    ...
                    <li data-transition="fade">
                        <img src="images/slides/2.jpg" alt="" width="1920" height="550"
                            data-bgposition="top center" data-bgfit="cover" data-bgrepeat="no-repeat"
                            data-bgparallax="1">
        ...
        <!-- easing -->
        <script src="frontend_assets/js/jquery.easing.min.js"></script>
        <!-- gmap helper -->
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAHzPSV2jshbjI8fqnC_C4L08ffnj5EN3A"></script>
        <!--gmap script-->
        <script src="frontend_assets/js/gmaps.js"></script>
        <script src="frontend_assets/js/map-helper.js"></script>
        <!-- fancy box -->
        <script src="frontend_assets/js/jquery.fancybox.pack.js"></script>
        <script src="frontend_assets/js/jquery.appear.js"></script>
        <!-- isotope script-->
        <script src="frontend_assets/js/isotope.js"></script>
        <script src="frontend_assets/js/jquery.prettyPhoto.js"></script>
        <script src="frontend_assets/js/jquery.bootstrap-touchspin.js"></script>
