    ...
    <header class="navbar-area">
        ...
        <div class="mobile-nav">
            <a href="index.html" class="logo">
                <img src="assets/Asset 2.png" alt="logo_light" />
                <img src="assets/Asset 2.png" alt="logo-dark" />
            </a>
        </div>
            ...
            <nav class="navbar navbar-expand-md navbar-light">
                <div class="container">
                    <a class="navbar-brand" href="index.html">
                        <img src="assets/Asset 2.png" width="200px" alt="logo_light" />
                        <img src="assets/Asset 2.png" width="200px" alt="logo-dark" />
                    </a>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="footer-widget">
                        <div class="navbar-brand">
                            <a href="/">
                                <img src="assets/Asset 2.png" alt="image" />
                            </a>
                        </div>
                        <p></p>
                        <div class="social-link">
